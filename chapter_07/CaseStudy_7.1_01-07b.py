"""
This version shows the alternative discussed in the book where we look at memoization of the function

It will throw an error because the model cannot be hashed.
You will see our final solution used a global variable to get around this
"""
